/**
 * Fundamentals of Computer Programing Final Project, 1st Semester, Silesian University of Technology (Gliwice Poland), Informatics in english major.
 *  Program that allows zipping and unzipping files.
 *  Program should implement DEFLATE algorithm by itself (no external library). 
 *  Program should be able to pack folder structure. 
 *  Parameters for DEFLATE algorithm should be kept in config file. 
 *  Program takes two parameters:
 * -i input file to pack
 * -o output where to store zipped file
 * 
 * @file Functions.h
